  ...
  return (
    ...
    <nav>
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href="https://x.com/VisionTey" target={"_blank"}
        whileHover={{y: -2}}
        whileTap={{scale:0.9}}
        className='w-6 mr-3'
        >
        ...
        <motion.a href="https://github.com/Vision-Tey" target={"_blank"}
        className='w-6 mx-3'
        whileHover={{y: -2}}
        whileTap={{scale:0.9}}
        >
        ...
        <motion.a href="https://www.linkedin.com/in/nimusiima-vision-082abb216" target={"_blank"}
        className='w-6 mx-3'
        whileHover={{y: -2}}
        whileTap={{scale:0.9}}
        >
