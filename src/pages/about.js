...
const about = () => {
    return (
        <>
            <Head>
                <title>VisionTey | About Page</title>
                <meta name='description' content='any description' />
            </Head>
            <TransitionEffect />
            <main className='flex w-full flex-col items-center justify-center dark:text-light'>
                <Layout className='pt-16'>
                    <AnimatedText text="Passion ignites purpose!" className='mb-16 !text-6xl lg:!text-6xl sm:!text-5xl xs:!text-4xl sm:mb-8' />
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                            ...
                            <p className='font-medium'>
                                I approach each project, be it a web app, mobile app, or any other digital product, with unwavering enthusiasm.
                        ...
                        bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8'>
                            ...
                            <Image src={profilePic} alt="VisionTey" className='w-full h-auto rounded-2xl'
                                priority
